                ...
                <div class="col-lg-12">
					...
					<?php 
						...
						while($fetch_lead=execute_fetch($sql_query)){
                             $read_lead_status=$fetch_lead['lead_status'];
                            if($read_lead_status=="assigned"){
                                $class="assigned";
                            }elseif($read_lead_status=="Not assined"){
                                $class="un_assigned";
                            }else{
                                $class="odd gradeX";
                            }
...
<?php 
 ...
 /*Showing Lead Status*/
function lead_status($user_type,$selected_lead_status){
              
              $selected_lead_status=convert_underscore_into_spaces($selected_lead_status);
        if($user_type=="master"){ 

            if (isset($_GET['call'])) {
                    $sql_lead="SELECT * FROM crm_leads tbl_leads, crm_employer tble_employer
                WHERE
                tbl_leads.lead_status='$selected_lead_status'
                AND
                tbl_leads.emp_id=tble_employer.emp_id";
                $label=$selected_lead_status;
             }
            ...
            else
            {
                 ...
                 $selected_lead_status=sql_injection($selected_lead_status);
                    ...
                    ?>
                                        ...
                                        <tr class="odd gradeX">
                                         <!--<td><input type="checkbox"></td>-->
                                            <td><?php echo $fetch_lead['lead_name'];?></td>
                                            <td><?php echo $fetch_lead['lead_mobile'];?></td>
                                            <td class='center'><?php echo  $fetch_lead['emp_name'];?></td>
                                             <td class="center">
                                                <?php
                                                    if($user_type=="master"){
                                                        ?>
                                                    <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu pull-right" role="menu">
                                                                    <li> <a href="../master/lead_log.php?lead_history_id=<?php echo $fetch_lead['lead_id']?>">
                                                                    <i class="fa fa-history" aria-hidden="true"></i> Lead Log</a>
                                                                    </li>
                                                                    <li><a href="#">Another action</a>
                                                                    </li>
                                                                    <li><a href="#">Something else here</a>
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                    <li><a href="openlead.php?lead_id=<?php echo $fetch_lead['lead_id'];?>">
                                    <i class="fa fa-folder-open" aria-hidden="true"></i>  Open</a>
                                        </li>
                                        </li>
                                       <li> <a href="../employees/lead_log.php?lead_history_id=<?php echo $fetch_lead['lead_id']?>">
                                         <i class="fa fa-history" aria-hidden="true"></i> Lead Log</a>
                                        </li>
