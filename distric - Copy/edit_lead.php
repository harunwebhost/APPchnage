        ...
        <div id="page-wrapper">
			...
			<input type="hidden" name="lead_id" value="<?php echo check_isset($olddata['lead_id']);?>">
				...
				<div class="col-md-12">
					...
					<input class="form-control" placeholder="Placeholder"
					 value="<?php echo check_isset($olddata['district_name']);?>"  name="field[district_name]">
					</div>
					</div>
				</div>
				...
				<div class="col-md-12">
					...
					<input class="form-control" placeholder="Placeholder"
					 value="<?php echo check_isset($olddata['assembly_name']);?>"  name="field[assembly_name]">
					</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
					...
					<input class="form-control" placeholder="Placeholder"
					 value="<?php echo check_isset($olddata['campaign_group_name']);?>"  name="field[campaign_group_name]">
					</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
